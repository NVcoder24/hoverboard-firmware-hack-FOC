...
#define DEFAULT_RATE                0   // 30.0f [-] lower value == slower rate [0, 32767] = [0.0, 2047.9375]. Do NOT make rate negative (>32767)
 ...
 *
 * After calibration you can optionally write the values to the followings
 * Procedure:
